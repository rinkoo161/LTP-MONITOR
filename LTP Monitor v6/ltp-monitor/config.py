...
DEFAULTS = {
    ...
    "spread_profit_target_pct": 30,   # close spread at this % of credit
    "spread_profit_lock_trigger_pct": 50,  # once P&L reaches this % of the
                                            # profit target, start locking in gains
    "spread_profit_lock_pct": 60,     # keep this % of the peak P&L once triggered
                                       # (a ratchet floor, not a one-time snapshot —
                                       # rises as new peaks are made)
