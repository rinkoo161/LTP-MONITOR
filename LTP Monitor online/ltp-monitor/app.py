...
APP_VERSION = "v60.00"   # maintained per explicit request; last delivered was v49
...
class SettingsIn(BaseModel):
    ...
    signal_repeat_spot_move_pct: float | None = None
    signal_repeat_geometry_pct: float | None = None
    ...
    watch_snapshot_interval_sec: int | None = None
    ...
    option_ai_min_hold_sec: int | None = None
    signal_invalidation_min_pct: float | None = None
