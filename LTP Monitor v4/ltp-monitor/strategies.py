...
SPREAD_BOUNDS = {
    ...
    "bull_put_spread":  {"wall_gap_frac": (0.4, 2.0, -1), "credit_min_frac": (0.08, 0.35, -1)},
    "bear_call_spread": {"wall_gap_frac": (0.4, 2.0, -1), "credit_min_frac": (0.08, 0.35, -1)},
}
...
def evaluate(name, analysis, regime):
    ...
    try:
        ...
        _p = {}
    wall_gap_frac = _p.get("wall_gap_frac", 0.8)
    credit_min_frac = _p.get("credit_min_frac", 0.15)
